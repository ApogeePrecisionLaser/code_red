 ...
 */
package com.codeRed.location.controller;

import com.codeRed.location.model.ZoneNewModel;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (task == null) {
            ...
            if (task.equals("Save As New") || task.equals("Save")) {
                ...
                String zoneDescription = request.getParameter("zoneDescription");
                String zone_no = request.getParameter("zone_no");
                ZoneNewBean zn = new ZoneNewBean();
                zn.setZoneId(zone_id);
                zn.setZoneName(zoneName);
                zn.setZone_no(zone_no);
                zn.setZoneDescription(zoneDescription);
                zoneModel.insertNewRecord(zn);
            }
