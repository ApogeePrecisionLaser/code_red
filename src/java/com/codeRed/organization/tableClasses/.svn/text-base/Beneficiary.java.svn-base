...
public class Beneficiary {
    private int beneficiary_id,no_of_person,person_code;
    private String occupation_name,person_name,type_of_beneficiary,description,is_residencial;
private String key_person_name,father_name,address;
private String zone,ward,area,location,zone_no,ward_no,area_no,location_no,rfid,mobile_no1;
    ...
    public String getIs_residencial() {
        return is_residencial;
    }

    public void setIs_residencial(String is_residencial) {
    ...
    public String getType_of_beneficiary() {
        return type_of_beneficiary;
    }

    public void setType_of_beneficiary(String type_of_beneficiary) {
        this.type_of_beneficiary = type_of_beneficiary;
    }
