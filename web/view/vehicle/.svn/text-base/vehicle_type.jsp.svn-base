...
<html>
    <head>
        ...
        jQuery(function(){
               $("#vehicleType").autocomplete("VehicleTypeController", {
               extraParams: {
...
function setStatus(id) {
    ...
    <form name="form0" action="VehicleTypeController">
...
<!--                   <input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="getlist()">
   ...
   <form name="form1" action="VehicleTypeController">
        ...
        <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
            ...
            <tr>
            <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)"> ${VehicleType.vehicle_type_id}</td>
        ...
        <br>
            ...
            <form  action="VehicleTypeController" method="post">
                           ...
                           <table  align="center"  class="content" cellpadding="2%" border="1">
                              ...
                              <tr><input class="input" type="hidden" id="vehicle_type_id" name="vehicle_type_id" value="" ></tr>
                              <tr>
