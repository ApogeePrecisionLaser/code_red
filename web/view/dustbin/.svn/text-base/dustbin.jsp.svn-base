...
<html>
    ...
    jQuery(function(){
        $("#dustbin_type").autocomplete("DustbinController", {
            extraParams: {
       ...
       $("#dustbinType").autocomplete("DustbinController", {
        ...
        $("#city_location").autocomplete("DustbinController", {
            extraParams: {
    ...
    function fillColumns(id)
     {
      ...
      document.getElementById("dustbin_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
      document.getElementById("dustbin_type").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
      document.getElementById("dustbin_no").value=document.getElementById(t1id + (lowerLimit + 3)).innerHTML;
      ...
      document.getElementById("city_location").value=document.getElementById(t1id + (lowerLimit + 6)).innerHTML;
  ...
  function myLeftTrim(str) {
     ...
     document.getElementById("dustbin_type").disabled = false;
     document.getElementById("dustbin_no").disabled = false;
        ...
        if(id == 'new') {
           $("#message").html("");
            ...
            document.getElementById("save_as").disabled =true;
             ...
             document.getElementById("dustbin_id").value=0;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Dustbin</b></td>
                                    </tr>
                                </table>
                            </td></tr>

   <form name="form0" action="DustbinController">
...
<!--                   <input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="getlist()">
   ...
   <form name="form1" action="DustbinController">
        ...
        <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
            ...
            <tr>
            <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)"> ${VehicleType.dustbin_id}</td>
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" align="center"> ${lowerLimit + loopCounter.count- noOfRowsTraversed }</td>
            <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${VehicleType.dustbin_type}</td>
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${VehicleType.dustbin_no}</td>
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${VehicleType.latitude}</td>
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${VehicleType.longitude}</td>
            <td id="t1c${IDGenerator.uniqueID}"  class="new_input" onclick="fillColumns(id)">${VehicleType.city_location}</td>
    ...
    <input type="hidden"  name="noOfRowsTraversed" value="${noOfRowsTraversed}">
      <input  type="hidden" name="dustbinType" value="${dustbinType}">
        </form>
        <br>
        <br>

            <form  action="DustbinController" method="post">
                           ...
                           <table  align="center"  class="content" cellpadding="2%" border="1">
                              ...
                              <tr><input class="input" type="hidden" id="dustbin_id" name="dustbin_id" value="" ></tr>

                              <tr>

                                 <th class="heading1"> Dustbin Type </th>
                                 <td><input type="text" class="new_input" id="dustbin_type" size="19" name="dustbin_type" value="" disabled></td>
                                 <th class="heading1">Dustbin No</th>
                                 <td><input type="text"  id="dustbin_no" size="19" name="dustbin_no" value="" disabled></td>
                              </tr>
                              <tr>
                                 <th class="heading1">Latitude</th>
                                 <td><input type="text"  id="latitude" size="19" name="latitude" value="" disabled></td>
                                  <th class="heading1">Longitude</th>
                                 <td><input type="text"  id="longitude" size="19" name="longitude" value="" disabled></td>
                              </tr>
                              <tr>
