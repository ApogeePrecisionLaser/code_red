 ...
 function getlist(){
  ...
  function openPopUp(url, window_name, popup_height, popup_width) {
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Type Of Occupation</b></td>
                                    </tr>
                                </table>
                            </td></tr>
    <form name="form0" action="TypeOfOccupationController">
                   ...
                   <td><input class="input new_input" type="text" id="searchtypeofoccupation" name="searchtypeofoccupation" value="${searchtypeofoccupation}" size="20" ></td>
   ...
   <form name="form1" action="TypeOfOccupationController">
    ...
    <input type="hidden"  name="noOfRowsTraversed" value="${noOfRowsTraversed}">
        ...
        <br>
                      ...
                      <form  action="TypeOfOccupationController" method="post">
                           ...
                           <table  align="center"  class="content" cellpadding="2%" border="1">
                              ...
                              <tr>
                                 ...
                                 <td><input type="text" class="new_input" id="name" size="12" name="name" value="" disabled></td>

                              </tr>
                             <tr>

                                 <th class="heading1"> Description</th>
                                 <td><input type="text" class="new_input"  id="description" size="12" name="description" value="" disabled></td>
