...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchName").autocomplete("userTypeCont",
        {
            extraParams: {
                action1: function() { return "getName"},
                action3: function() { return document.getElementById("searchMobileNo").value},
                action4: function() { return document.getElementById("searchEmailId").value}
            }
        });
        $("#searchMobileNo").autocomplete("userTypeCont",
        {
            extraParams: {
        ...
        $("#searchEmailId").autocomplete("userTypeCont", {
            extraParams: {
                action1: function() { return "getEmailId"},
                action2: function() { return document.getElementById("searchName").value;},
                action3: function() { return document.getElementById("searchMobileNo").value;}
            }
        });
    ...
    function displayMapList(id)
    {
        ...
        if(id == "viewPdf")
            queryString = "task=generateReport&searchName="+searchName+"&searchMobileNo="+searchMobile_no+"&searchEmailId="+searchEmailId+"&searchDate="+searchDate;
        else
            queryString = "task=generateXlxReport&searchName="+searchName+"&searchMobileNo="+searchMobile_no+"&searchEmailId="+searchEmailId+"&searchDate="+searchDate;
        var url = "userTypeCont?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>User Detail</b></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div align="center">
                                    <form name="form0" method="post" action="userTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                ...
                                                <th>Email_id</th>
                                                <td><input class="input" type="text" id="searchEmailId" name="searchEmailId" value="${searchEmailId}" size="30" ></td>
                                            </tr>
                                            <tr>
                                                <th>Date</th>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="post" action="userTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                ...
                                                <th class="heading">Email_id</th>
                                                <th class="heading">Mobile No Verified</th>
                                            ...
                                            <c:forEach var="list" items="${requestScope['List']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.email_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.mobile_no_verified}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.gender}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.blood_group}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.created_date}</td>
