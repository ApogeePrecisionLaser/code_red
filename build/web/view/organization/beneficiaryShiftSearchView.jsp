...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            jQuery(function(){
//                $("#searchOrgOfficeType").autocomplete("beneficiaryShiftSearchCont.do", {
//                    extraParams: {
...
//                });
            ...
            jQuery(function(){
                $("#searchOrgOfficeCode").autocomplete("beneficiaryShiftSearchCont.do", {
                    extraParams: {
                        action1: function() { return "getOrganisationOfficeCode"}
                    }
                });
                $("#office_code").autocomplete("beneficiaryShiftSearchCont.do", {
                    extraParams: {
                        action1: function() { return "getOrganisationOfficeCode"}
                    }
                });
             ...
             function orgOfficeReport(id)
            {
                ...
                var url="beneficiaryShiftSearchCont.do?"+action;
            ...
            function openCurrentMap(longitude, lattitude) {
                            ...
                            popupWindow(url,"Org_Office_View_Report");
                            //window.open(url);
                    ...
                    <DIV id="body" class="maindiv">
                        <table width="100%">
                            <tr><td>
                                    <table>
                                        <tr>
                                            <td align="center" class="header_table"  width="1000">Beneficiary Shift Search</td>
                            ...
                            <tr>
                                <td align="center">
                                    <form name="form0" method="POST" action="beneficiaryShiftSearchCont.do">
                                        <table  align="center"  class="heading1" >
                                            <tr>
                                                <th>Beneficiary Mobile no.</th>
                                                <td><input class="input" type="text" id="searchOrgOfficeType" name="searchOrgOfficeType" value="${searchOrgOfficeType}" size="30" ></td>
                            ...
                            <tr>
                                <td align="center">
                                    <form name="form1" method="POST" action="beneficiaryShiftSearchCont.do">
...
<!--                                                <tr>
                                                ...
                                                <c:forEach var="orgOfficeType" items="${requestScope['orgOfficeTypeList']}" varStatus="loopCounter">
                                                    <tr>
                                                        ...
                                                        <td>${orgOfficeType.person_name}</td>
                                                        <th>Area</th>
                                                        <td>${orgOfficeType.area}</td>
                                                        <th>Location</th>
                                                        <td>${orgOfficeType.location}</td>
                                                    </tr>
...
<%--                                                                <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">
                                                                ...
                                                                <th>Employee Name</th>
                                                                <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" >${orgOfficeType.name}</td>
                                                                <th>Mobile No.</th>
                                                                <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" >${orgOfficeType.mobile_no}</td>
                                                                <th>Date</th>
                                                                <td>${orgOfficeType.date}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Time From</th>
                                                        <td>${orgOfficeType.start_time}</td>
                                                        <th>Time To</th>
                                                        <td>${orgOfficeType.end_time}</td>
                                                        <td colspan="2" align="center"><input id="map" class="" type="button" onclick="openCurrentMap('${orgOfficeType.emp_code}' , '');" value="Current Location"></td>
                                                    </tr>
                                                </c:forEach>
                                                <%--<tr>
...
<!--          <%--                  <tr>
                                <td align="center">
                                    <div >
                                        <form name="form2" method="POST" action="beneficiaryShiftSearchCont.do" onsubmit="return verify()">
