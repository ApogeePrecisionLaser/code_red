    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function play()
            {
                ...
                audio.play();
                var result=true;
                while(result=confirm("Please Click OK to Stop Audio..")){
                    play();
                }
                location.reload();
                //                if(result){
            ...
            jQuery(function(){
                ...
                $("#searchMobileNo").autocomplete("complaintCont.do",
                {
                    extraParams: {
            ...
            function makeEditable(id)
            {
                ...
                doc.getElementById("is_emergency").disabled = false;
                doc.getElementById("text").disabled = false;
                doc.getElementById("parentHeaderName").disabled = false;
                doc.getElementById("officer_name").disabled = false;
                doc.getElementById("officer_code").disabled = false;
                doc.getElementById("latitude").disabled = false;
                doc.getElementById("longitude").disabled = false;
                doc.getElementById("getParentHeader").disabled = false;
            ...
            function fillColumns(id) {
                ...
                doc.getElementById("complain_revision").value = doc.getElementById("complain_revision" + rowNum).value;
                ...
                doc.getElementById("victim_name").value = doc.getElementById(t1id +(lowerLimit+3)).innerHTML;
                doc.getElementById("mobile_no").value = doc.getElementById(t1id +(lowerLimit+4)).innerHTML;
                var date_time = doc.getElementById(t1id +(lowerLimit+5)).innerHTML;
                ...
                doc.getElementById("text").value = doc.getElementById(t1id +(lowerLimit+6)).innerHTML;
                doc.getElementById("parentHeaderName").value = doc.getElementById("node_name" + rowNum).value;
                doc.getElementById("is_emergency").value = doc.getElementById(t1id +(lowerLimit+8)).innerHTML;
                doc.getElementById("officer_name").value = doc.getElementById(t1id +(lowerLimit+9)).innerHTML;
                doc.getElementById("remark").value = doc.getElementById(t1id +(lowerLimit+10)).innerHTML;
                //doc.getElementById("status").value = doc.getElementById(t1id +(lowerLimit+9)).innerHTML;
                doc.getElementById("latitude").value = doc.getElementById(t1id +(lowerLimit+12)).innerHTML;
                doc.getElementById("longitude").value = doc.getElementById(t1id +(lowerLimit+13)).innerHTML;
            ...
            function displayMapList(){
                ...
                var url = "complaintCont.do?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td>
                                <div align="center">
                                    <form name="form0" method="get" action="complaintCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="complaintCont.do">
                                    <DIV class="content_div">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                ...
                                                <th  class="heading">Emergency</th>
                                                <th  class="heading">Officer</th>
                                                <th  class="heading">Description</th>
                                                <th  class="heading">Status</th>
                                                <th  class="heading">Latitude</th>
                                                <th  class="heading">Longitude</th>
                                                <th  class="heading">Police Involve</th>
                                            ...
                                            <c:forEach var="complaintBean" items="${requestScope['complaintList']}" varStatus="loopCounter">
                                                <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">
                                                        ...
                                                        <input type="hidden" id="complain_revision${loopCounter.count}" value ="${complaintBean.revision_no}">
                                                        <input type="hidden" id="status_id${loopCounter.count}" value ="${complaintBean.status_id}">
                                                        <input type="hidden" id="node_id${loopCounter.count}" value ="${complaintBean.node_id}">
                                                    </td>
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)">
                                                        ${complaintBean.fullNodeName}
                                                        <input type="hidden" id="node_name${loopCounter.count}" value ="${complaintBean.node_name}">
                                                    </td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)">${complaintBean.is_emergency}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" >${complaintBean.officer_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)">${complaintBean.remark}</td>
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" >${complaintBean.police_involve}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="complaintCont.do" onsubmit="return verify()">
                    ...
                    <%--   <img id="ss" src="http://www.partyplan123.com/wp-content/uploads/2015/02/click-here.jpg" onclick="play()"> --%>
                    <%--   <audio id="audio" src="http://122.176.75.92:8080/CodeRed/audios/audio.mp3" ></audio>    autoplay --%>
