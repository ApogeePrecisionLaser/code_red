...
<html>
    ...
    <script type="text/javascript">
         jQuery(function(){
           $("#searchduty_type").autocomplete("dutyTypeCont.do", {
            extraParams: {
                action1: function() { return "getDuty" }
            }
              });
          });
     function fillColumns(id)
     {
      ...
      document.getElementById("duty_type_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
      document.getElementById("duty_type").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
      ...
      {
        document.getElementById("duty_type").disabled = false;
        ...
        document.getElementById("duty_type").disabled=false;
        document.getElementById("remark").disabled=false;
        document.getElementById("duty_type").focus();
        }
      }
    ...
    function verify()
    {
                ...
                if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                    if((document.getElementById("duty_type").value).trim().length == 0) {
            ...
            <tr>
                 <td>
                     <div class="maindiv" id="body">
                       <form name="form" action="dutyTypeCont.do">

                           <table width="100%" align="center" >
                                   <tr align="center">
                                        <td>

                                                   <span class="heading1">Duty Type</span>
                                                   <input class="input" type="text" id="searchduty_type" name="searchduty_type" value="${searchduty_type}" size="30">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        ...
                                        <form name="form1" action="dutyTypeCont.do">
                                           <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                <TR>
                                                     <th class="heading" >S.no</th>
                                                     <th class="heading" >Duty Type</th>
                                                     <th class="heading" >remark</th>
                                                </TR>
                                                <c:forEach var="duty_type" items="${requestScope['list']}" varStatus="loopCounter">
                                                  <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${duty_type.duty_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${duty_type.duty_type}</TD>
                                                    <TD id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${duty_type.remark}</TD>
                                                  </TR>
                                                </c:forEach>
                                                                    ...
                                                                    <c:when test="${showNext eq 'false'}">
                                                                      <input class="button" type='submit' name='buttonAction' value='Next' disabled>
                                                                           ...
                                                                           <input class="button" type='submit' name='buttonAction' value='Next'>
                                                                             ...
                                                                             <input type="hidden"  id="searchduty_type" name="searchduty_type" value="${searchduty_type}">

                                                                                <input type="hidden" id="noOfRowsTraversed" name="noOfRowsTraversed" value="${noOfRowsTraversed}">
                                                                            </form>
                                        </div>
                                        <div  style="width:990px" >
                                            <form name="form2" action="dutyTypeCont.do" onsubmit="return verify()">
                                                                                ...
                                                                                <tr>
                                                                                   <td>Duty Type</td>
                                                                                   <td><input class="input" type="hidden" id="duty_type_id" name="duty_type_id" value="" >
                                                                                   <input class="input" type="text" id="duty_type" name="duty_type" value="" disabled>
                                                                                </td>
                                                                               </tr>
                                                                               <tr>
                                                                                     <td>remark</td>
