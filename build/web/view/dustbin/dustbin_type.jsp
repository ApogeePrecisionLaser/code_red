...
<html>
    ...
    function fillColumns(id)
     ...
     document.getElementById("dustbin_type_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
     document.getElementById("dustbin_type").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
       document.getElementById("height").value=document.getElementById(t1id + (lowerLimit + 3)).innerHTML;
         document.getElementById("volume").value=document.getElementById(t1id + (lowerLimit + 4)).innerHTML;
        ...
        if(id == 'new') {
           $("#message").html("");
            ...
            document.getElementById("save_as").disabled =true;
             ...
             document.getElementById("dustbin_type_id").value=0;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Dustbin Type</b></td>
                                    </tr>
                                </table>
                            </td></tr>

   <form name="form0" action="DustbinTypeController">
...
<!--                   <input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="getlist()">
   ...
   <form name="form1" action="DustbinTypeController">
        ...
        <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
            ...
            <tr>
            <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)"> ${VehicleType.dustbin_type_id}</td>
            ...
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${VehicleType.height}</td>
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${VehicleType.volume}</td>
    ...
    <input type="hidden"  name="noOfRowsTraversed" value="${noOfRowsTraversed}">
     <input  type="hidden" name="dustbinType" value="${dustbinType}">
        ...
        <br>
            ...
            <form  action="DustbinTypeController" method="post">
                           ...
                           <table  align="center"  class="content" cellpadding="2%" border="1">
                              ...
                              <tr><input class="input" type="hidden" id="dustbin_type_id" name="dustbin_type_id" value="" ></tr>
                              <tr>
                                 ...
                                 <th class="heading1">Height</th>
                                 <td><input type="text"  id="height" size="19" name="height" value="" disabled></td>
                              </tr>
                             <tr>
                                 <th class="heading1">Volume</th>
                                 <td><input type="text" id="volume" size="19" name="volume" value="" disabled></td>
